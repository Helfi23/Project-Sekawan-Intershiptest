                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('cars.update',$car->car_id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <input type="text" name="merk"
                                    ...
                                    placeholder="" value="{{old('merk',$car->merk)}}" />
                            </label>
                            @error('merk')
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <textarea
                                    ...
                                    name="tipe" rows="3">{{old('tipe', $car->tipe)}}</textarea>
                            </label>
                            @error('tipe')
                            <div class="flex items-center text-sm text-red-600">
                                {{ $message }}
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <textarea
                                    ...
                                    name="plat_nomor" rows="3">{{old('plat_nomor',$car->plat_nomor)}}</textarea>
                            </label>
                            @error('plat_nomor')
                            <div class="flex items-center text-sm text-red-600">
                                {{ $message }}
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <textarea
                                    ...
                                    name="tahun_pembuatan" rows="3">{{old('tahun_pembuatan',$car->tahun_pembuatan)}}</textarea>
                            </label>
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <textarea
                                    ...
                                    name="kapasitas_penumpang" rows="3">{{old('kapasitas_penumpang',$car->kapasitas_penumpang)}}</textarea>
                            </label>
                        ...
                        <div class="mb-6">
                            ...
                            @enderror
                            <img class="w-full h-48 object-cover object-center" src="{{ asset('images/'.$car->photo) }}" alt="{{ $car->name }}">
                        </div>
                        <button type="submit"
